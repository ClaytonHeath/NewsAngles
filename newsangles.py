...
def generate_editor(headline_strings):
    ...
    response = openai.ChatCompletion.create(
        ...
        messages=[
            ...
            {"role": "user", "content": "Assess each of the following news headlines for story leads. Record your assessment in dot point notes to offer reporting angles that a journalist could follow up. Your assessment should: Focus on new and different perspectives to reveal something not yet known; Include a hypothesis for each headline by being imaginative and precise; Suggest examples, ideas and form questions to test the hypothesis. Use SCAMPER technique to unlock fresh angles. The headlines are:"},
